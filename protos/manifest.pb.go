...
type ManifestChange struct {
	...
	MaxCASCounter uint64                   `protobuf:"varint,4,opt,name=MaxCASCounter,proto3" json:"MaxCASCounter,omitempty"`
...
func (m *ManifestChange) GetMaxCASCounter() uint64 {
	if m != nil {
...
func (m *ManifestChange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MaxCASCounter != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintManifest(dAtA, i, uint64(m.MaxCASCounter))
	}
	if len(m.Smallest) > 0 {
		dAtA[i] = 0x2a
		i++
...
func (m *ManifestChange) Size() (n int) {
	...
	if m.MaxCASCounter != 0 {
		n += 1 + sovManifest(uint64(m.MaxCASCounter))
	}
	l = len(m.Smallest)
	if l > 0 {
		n += 1 + l + sovManifest(uint64(l))
...
var fileDescriptorManifest = []byte{
	...
	0xab, 0x58, 0x0f, 0x55, 0x6d, 0x10, 0x4c, 0x99, 0xd2, 0x4b, 0x46, 0x2e, 0x3e, 0x54, 0x39, 0x21,
	...
	,
}
